...
static void create_buffer(Locus *app) {
    ...
    app->cairo_surface = cairo_image_surface_create_for_data(app->shm_data,
                                                             CAIRO_FORMAT_ARGB32,
...
void locus_set_draw_callback(Locus *app, void (*draw_callback)(cairo_t *cr, int width, int height)) {
